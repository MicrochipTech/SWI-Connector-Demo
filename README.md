...
This demo uses the [**PIC16F18875**](https://www.microchip.com/wwwproducts/en/PIC16F18875) (Rev1) or [**PIC18F47Q10**](https://www.microchip.com/wwwproducts/en/PIC18F47Q10) (Rev2) MCU. Other microcontrollers might not work, so please double-check that your Curiosity board uses one of these MCUs.

> **Note:** `Firmware/DemoRev1.X` targets the **Rev 1** Curiosity HPC board (**PIC16F18875**). `Firmware/DemoRev2.X` targets the **Rev 2+** Curiosity HPC board (**PIC18F47Q10**). The projects were originally built with MPLAB X IDE v5.20 and XC8 v2.05, and have been updated for MPLAB X IDE v6.35, XC8 v4.00, PIC16F1xxxx_DFP v1.31.465 (Rev1), and PIC18F-Q_DFP v1.30.487 (Rev2+).
